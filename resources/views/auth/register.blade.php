                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-label-group">
                                        <input type="password" name="password_confirmation" id="inputPassword1"
                                    ...
                                    <button type="submit"
                                        class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Sing
                                        Up </button>
                                    <div class="text-center pt-3">
                                        Have an account? <a class="font-weight-bold"
