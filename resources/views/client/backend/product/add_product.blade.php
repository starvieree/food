                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-body p-4">
                            <form id="myForm" action="{{ route('store.product') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="best_seller" type="checkbox" id="formCheck" value="1">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="most_populer" type="checkbox" id="formCheck2" value="2">
