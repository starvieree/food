                                ...
                                <div class="col-sm order-2 order-sm-1">
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <h5 class="font-size-16 mb-1">{{ $profileData->name ?? 'Name Unavailable' }}
                                                </h5>
                                                <p class="text-muted font-size-13">
                                                    {{ $profileData->email ?? 'Email Unavailable' }}</p>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="name" type="text"
                                                value="{{ $profileData->name ?? 'Name Unavailable' }}"
                                                id="example-text-input">
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Email</label>
                                            <input class="form-control" name="email" type="email"
                                                value="{{ $profileData->email ?? 'Email Unavailable' }}"
                                                id="example-text-input">
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Phone</label>
                                            <input class="form-control" name="phone" type="text"
                                                value="{{ $profileData->phone ?? 'Phone Unavailable' }}"
                                                id="example-text-input">
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="mt-3 mt-lg-0">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="address" type="text"
                                                value="{{ $profileData->address ?? 'Address Unavailable' }}"
                                                id="example-text-input">
                                        </div>
                                        <div class="mb-3">
